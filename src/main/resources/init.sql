...
INSERT INTO address (id, street, building_number, city, postal_code, version) VALUES (1, 'Main Street', 12, 'New York', '12-345', 1), (2, 'Abbey Road', 7, 'London', '34-123', 1), (3, 'Champs-Élysées', 15, 'Paris', '12-345', 1);

INSERT INTO account (id, email, username, password, is_enable, is_active, register_date, language_, version) VALUES (1, 'johndoe@example.com', 'johndoe', 'odszyfruj bcrypta $2a$12$UDQ6JlncTHbDbOeATjGr8.zx0uj66K6hUDugJqjLF248FG.uPSLe.', TRUE, TRUE, NOW(), 'EN', 1), (2, 'janekowalski@example.com', 'janekowalski', '$2a$12$7s7AjPDVjsCCpIHHwE0ZH.zG6opHvjO.YO8.cmZ2JiLZMs3.QAU/2', TRUE, TRUE, NOW(), 'PL', 1), (3, 'maria.silva@example.com', 'mariasilva', '$2a$12$lSUDcv1i1j6IeSa7DzBnkOZm90e.hLalhip0r5rvMhAvWII5D4OBi', TRUE, TRUE, NOW(), 'PT', 1);

INSERT INTO personal_data (id, first_name, surname, version) VALUES (1, 'John', 'Doe', 1), (2, 'Jan', 'Kowalski', 1), (3, 'Maria', 'Silva', 1);

INSERT INTO login_data (id, last_valid_login_date, last_valid_logic_address, last_invalid_login_date, last_invalid_logic_address, invalid_login_counter, version) VALUES (1, NOW() - INTERVAL '1 day', '192.168.0.1', NOW() - INTERVAL '3 days', '192.168.0.2', 2, 1), (2, NOW() - INTERVAL '5 days', '10.0.0.1', NOW() - INTERVAL '8 days', '10.0.0.2', 2, 1), (3, NOW() - INTERVAL '2 days', '192.168.1.1', NOW() - INTERVAL '4 days', '192.168.1.2', 0, 1);

INSERT INTO access_level_mapping (id, access_level, account_id, version) VALUES (1, 'admin', 1, 1), (2, 'manager', 2, 1), (3, 'owner', 3, 1);

INSERT INTO admin (id) VALUES (1);

INSERT INTO manager (id, license) VALUES (2, '12345678912345678912');

INSERT INTO owner (id, phone_number) VALUES (3, '123456789');

INSERT INTO heat_distribution_centre (id, version) VALUES (1, 1);

INSERT INTO heat_distribution_centre_pay_off (id, date_, consumption, consumption_cost, heating_area_factor, heat_distribution_centre_id, manager_id, version) VALUES (1, '2022-01-01', 500.00, 2500.00, 0.75, 1, 2, 1);

INSERT INTO building (id, total_area, communal_area_aggregate, address_id, heat_distribution_centre_id, version) VALUES (1, 200.00, 50.00, 1, 1, 1);

INSERT INTO place (id, area, hot_water_connection, central_heating_connection, predicted_hot_water_consumption, building_id, owner_id, version) VALUES  (1, 50.25, TRUE, TRUE, 15.55, 1, 3, 1);

INSERT INTO past_quarter_hot_water_pay_off (id, average_consumption, days_number_in_quarter, version) VALUES (1, 12.34, 90, 1);

INSERT INTO advance (id, date_, place_id, version) VALUES  (1, '2023-01-01', 1, 1), (2, '2021-01-01', 1, 1), (3, '2022-01-01', 1, 1);

INSERT INTO hot_water_advance (id, hot_water_advance_value) VALUES  (1, 1000.00), (2, 800.00), (3, 1500.00);

INSERT INTO hot_water_entry (id, date_, entry_value, place_id, manager_id, version) VALUES (1, '2022-01-01', 150.00, 1, 2, 1);

INSERT INTO annual_balance (id, year_, total_hot_water_advance, total_heating_place_advance, total_heating_communal_area_advance, total_hot_water_cost, total_heating_place_cost, total_heating_communal_area_cost, place_id, version) VALUES  (1, 2023, 3000.00, 2500.00, 1500.00, 2800.00, 1800.00, 1100.00, 1, 1);

INSERT INTO month_pay_off (id, payoff_date, water_heating_unit_cost, central_heating_unit_cost, hot_water_consumption, owner_id, place_id, version) VALUES  (1, '2022-03-01', 10.50, 30.00, 12.30, 3, 1, 1), (2, '2021-03-01', 12.20, 28.50, 18.20, 3, 1, 1), (3, '2023-03-01', 9.80, 31.20, 15.60, 3, 1, 1);

INSERT INTO heating_place_and_communal_area_advance (id, heating_place_advance_value, heating_communal_area_advance_value, advance_change_factor) VALUES  (1, 1200.00, 800.00, 0.9), (2, 900.00, 600.00, 0.8), (3, 1800.00, 1200.00, 0.85);